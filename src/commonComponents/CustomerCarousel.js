    ...
    <>
      ...
      >
        ...
        <div className="user-customer-profile-data text-left">
          ...
          <p className="listing-card-label-paragraph text-left font-regular text-white mt-3">{props.text}</p>
          <p className="listing-card-label-paragraph text-left font-regular text-white mt-3">{props.detail}</p>
        </div>
      </div>
    </>
  );
